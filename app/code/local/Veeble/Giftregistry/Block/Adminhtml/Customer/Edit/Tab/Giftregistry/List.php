 ...
 * Time: 13:51
 */
class Veeble_Giftregistry_Block_Adminhtml_Customer_Edit_Tab_Giftregistry_List extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('veeble_giftregistry/entity')
            ->getCollection()
